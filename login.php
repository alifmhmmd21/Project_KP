				...
				<div class="col-md-7 col-lg-5">
                    ...
                    <h5 class="mb-4" style="background:-webkit-linear-gradient(#000000,#F21717); -webkit-background-clip: text;-webkit-text-fill-color: transparent; text-align:center;"> Login Admin<br>PT. Teknologi Server Indonesia</h5>
                        ...
                        <form method="POST" id="contactForm" name="contactForm" class="contactForm" action="ceklogin.php">
                            ...
                            <input type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="addon-wrapping" name="user" id="user"></div>
                            <br>
                            <div class="input-group flex-nowrap">
                            <span class="input-group-text" id="addon-wrapping">#</span>
                            <input type="password" class="form-control" placeholder="Password" aria-label="Password" aria-describedby="addon-wrapping" name="password" id="paswword"></div>
                            <br>
                                <div class="form-group">
									<div class="right">
										<input type="submit" autocomplete="off" value="Login" class="btn btn-danger " name="submit">
									</div>
                                </div>
                        </form>
                    </div>
